...
public class UIController extends WebSecurityConfigurerAdapter {
    ...
    public String loadCustomers(Model model) {
        ...
        try {
            ResponseEntity<Customer[]> responseEntity = restTemplate.exchange("http://ec2-18-188-144-37.us-east-2.compute.amazonaws.com:8181/services/customers", HttpMethod.GET, customerHttpEntity, Customer[].class);
